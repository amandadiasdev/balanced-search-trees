...
{Os testes exercitam os quatro casos de desbalanceamento: esquerda-esquerda (LL), direita-direita (RR), esquerda-direita (LR) e direita-esquerda (RL). LL e RR usam uma rotação simples; LR e RL usam uma rotação dupla.}

{Outro teste executa 1.000 mutações com semente 5, compara as consultas com referências independentes e chama \texttt{assert\_valid} após cada operação.}
