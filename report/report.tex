...
{O grupo adotou transparência como critério para o uso de inteligência artificial. As conversas estão disponíveis no GitHub\footnote{\externallink{Acessar os registros de conversas}{https://github.com/amandadiasdev/balanced-search-trees/tree/main/conversation-logs}}.}
